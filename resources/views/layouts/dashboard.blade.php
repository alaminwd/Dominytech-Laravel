        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{asset('back-end/images/logo.png ')}}" alt="">
                <img class="logo-compact" src="{{asset('back-end/images/logo-text.png ')}}" alt="">
                <img class="brand-title" src="{{asset('back-end/images/logo-text.png ')}}" alt="">
            </a>
					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						<div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
							...
							<div class="card-body contacts_body p-0 dz-scroll  " id="DZ_W_Contacts_Body">
								<ul class="contacts">
									<li class="name-first-letter" style="display: flex !important; ">
										<p class="mb-0 font-weight-medium">{{App\Models\UserMessage::where('status', 0)->count()}} New Notifications</p>
										<a href="#" id="clear-all-notifications" class="text-muted" style="font-size: 14px; color:#0B2A97 !important; margin-left:25px ">Clear all</a>
									</li>
									@forelse ( App\Models\UserMessage::where('status', 0)->get() as $message  )
										<form action="{{ route('notifications.view') }}"  method="GET">
											@csrf
											<button class="dropdown-item" type="submit" name="message_id" value="{{$message->id}}">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css">{{App\Models\ContactMessage::where('status', 0)->count()}}</div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<div class="noti-info" style="display: flex !important">
											<p class="mb-0 font-weight-medium">{{App\Models\ContactMessage::where('status', 0)->count()}} New Messages</p>
											<a href="javascript:;" id="clearmessage" class="text-muted" style="font-size: 16px; color:#0B2A97 !important; margin-left:30px ">Clear all</a>
										</div>
										<ul class="timeline">
											@forelse (App\Models\ContactMessage::where('status', 0)->get() as $contact_message )
											<form action="{{ route('view.message') }}"  method="GET">
												@csrf
												<button class="dropdown-item" type="submit" name="contact_id" value="{{$contact_message->id}}">
													<li>
														<div class="timeline-panel">
															...
															<div class="media-body">
																<h6 class="mb-1">{{$contact_message->name}}</h6>
																<small class="d-block">{{$contact_message->created_at->diffForHumans()}}</small>
															</div>
														</div>
													</li>
												</button>
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="javascript:void(0)">
									...
									<div class="pulse-css">{{App\Models\UserMessage::where('status', 0)->count()}}</div>
                                </a>
							</li>
							<li class="nav-item dropdown notification_dropdown">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    @if (Auth::user()->photo == null)
										...
										@else
										<img width="50" src="{{asset('upload/user')}}/{{Auth::user()->photo}}" alt="">
										@endif
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{{route('index')}}" aria-expanded="false">
						<i class="fa-solid fa-house"></i>
						{{-- <i class="flaticon-381-networking"></i> --}}
							<span class="nav-text">Web Site</span>
						</a>
                        {{-- <ul aria-expanded="false">
							<li><a  href="{{route('index')}}">web page</a></li>
						</ul> --}}
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a  href="{{route('userInfo')}}">user information</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-bars"></i>
							<span class="nav-text">Navbar & Banner </span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('navbar.menu')}}">Navbar Menu</a></li>
                            <li class="nav-item"><a href="{{route('menu.logo')}}" class="nav-link">Add Logo</a></li>
                			<li class="nav-item"><a href="{{route('banner')}}" class="nav-link">Edit Banner</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li class="nav-item"><a href="{{route('edit.about')}}" class="nav-link">Update About</a></li>
							<li class="nav-item"><a href="{{route('brand')}}" class="nav-link">Add Brand</a></li>
							<li class="nav-item"><a href="{{route('support')}}" class="nav-link">Support</a></li>
							<li class="nav-item"><a href="{{route('solution')}}" class="nav-link">Solution</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-list"></i>
							<span class="nav-text">Catalogue Manage</span>
						</a>
                        <ul aria-expanded="false">
                            <li class="nav-item">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li class="nav-item">
								<a href="{{route('project')}}" class="nav-link">Add Projects</a>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li class="nav-item">
								<a href="{{route('blog')}}" class="nav-link">Add Blog</a>
							  </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li class="nav-item">
								<a href="{{route('testimonial')}}" class="nav-link">Add Review</a>
							  </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li class="nav-item"><a href="{{route('request.message')}}" class="nav-link">Request Message</a></li>
							<li class="nav-item"><a href="{{route('contact.message')}}" class="nav-link">Contact Message</a></li>
							<li class="nav-item"><a href="{{route('social')}}" class="nav-link">Add Social Icon</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li class="nav-item">
								<a href="{{route('footer')}}" class="nav-link">Update Footer Info</a>
							  </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li class="nav-item">
								<a href="{{route('contact')}}" class="nav-link">Add Content</a>
							  </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li class="nav-item">
								<a href="{{route('seo')}}" class="nav-link">Add SEO Page</a>
							  </li>
                        </ul>
                    </li>
                </ul>
	...
	<script>
	 ...
	 <script>
		$(document).ready(function() {
			$('#clear-all-notifications').on('click', function() {
				$.ajax({
					...
					success: function(response) {
						if (response.success) {
							// Update the UI to reflect the cleared notifications
							$('.dropdown-body').html('<p class="text-center">No new notifications</p>');
							$('.count').text('0');
							$('.dropdown-header p').text('0 New Notifications');
							toastr.success('All notifications have been cleared.');
						}
					}
				});
			});
			...
			//     $.ajax({
			//         url: '/notifications/view/' + messageId,
			//         type: 'POST',
			//         data: {
			//             _token: '{{ csrf_token() }}'
			//         },
			//         success: function(response) {
			//             if (response.success) {
			//                 toastr.success('Notification marked as viewed.');
			//             }
			//         }
			//     });
			// });
				...
				$.ajax({
					...
					success: function(response) {
						if (response.success) {
							...
							$('.dropdown-body').html('<p class="text-center">No new Message</p>');
							$('.count').text('0');
							toastr.success('All Message have been cleared.');
						}
					}
				});
			});
